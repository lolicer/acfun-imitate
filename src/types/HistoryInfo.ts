...
export type HistoryInfo = VideoHistoryInfo | LiveHistoryInfo | ArticleHistoryInfo

// 类型守卫函数
export const isVideoHistoryInfo = (item: HistoryInfo): item is VideoHistoryInfo => {
  return 'duration' in item && 'position' in item;
};

export const isLiveHistoryInfo = (item: HistoryInfo): item is LiveHistoryInfo => {
  return 'isLiveOn' in item;
};

export const isArticleHistoryInfo = (item: HistoryInfo): item is ArticleHistoryInfo => {
